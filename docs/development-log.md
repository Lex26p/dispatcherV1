...
Добавлен Windows и Linux GitHub Actions CI.
...
- pinned vcpkg;
- Windows backend configure и build;
- Windows CTest;
- Linux Debug configure, build и CTest;
- Linux Release configure, build и CTest;
- frontend restore и build;
